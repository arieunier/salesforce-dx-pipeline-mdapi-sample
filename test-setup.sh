...
export TICKS=$(echo $(date +%s | cut -b1-13))

# Name of your team (optional)
export HEROKU_TEAM_NAME="" 

# Name of the Heroku apps you'll use
export HEROKU_DEV_APP_NAME="dev$TICKS"
export HEROKU_STAGING_APP_NAME="staging$TICKS"
export HEROKU_PROD_APP_NAME="prod$TICKS"

# Pipeline
export HEROKU_PIPELINE_NAME="pipeline$TICKS"

# Usernames or aliases of the orgs you're using
export DEV_HUB_USERNAME="HubOrg"
export DEV_USERNAME="DevOrg"
export STAGING_USERNAME="TestOrg"
export PROD_USERNAME="ProdOrg"

# Repository with your code
export GITHUB_REPO="arieunier/salesforce-dx-pipeline-sample"

### Setup script

# Support a Heroku team
export HEROKU_TEAM_FLAG=""
if [ ! "$HEROKU_TEAM_NAME" == "" ]; then
  export HEROKU_TEAM_FLAG="-t $HEROKU_TEAM_NAME"
fi
